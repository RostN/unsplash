...
object AppAuth {
    ...
    object AuthConfig {
        ...
        const val SCOPE =
            "read_user public write_user read_photos write_photos write_likes write_followers read_collections write_collections"
        const val CALLBACK_URL = "com.example.attestation://callback"
        const val LOGOUT_CALLBACK_URL = "com.example.attestation://callback"
    }
}